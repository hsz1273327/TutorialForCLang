...
int call_func_example(PyObject* pModule) {
...
int callpy() {
    ...
    if (pModule != NULL) {
        auto res_call_func_example = call_func_example(pModule);
        if (res_call_func_example) {
            printf("res_call_func_example > 0");
            Py_XDECREF(pModule);
            return res_call_func_example;
        }
        printf("res_call_func_example is 0");
    } else {
